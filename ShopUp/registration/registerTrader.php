...
<head>
  ...
  <style>
    ...
    .row-trader {
      margin-top: 1rem;
      box-shadow: 7px 10px 10px 0px #c6c6c6;
    }
...
<body>
          ...
          <div class="d-flex flex-row justify-content-between ">
            <div class="p-2 d-flex align-items-center pad-link">
              <ul class="navbar-nav mr-auto " id="myul" style="font-size: 20px;">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                    <ul class="navbar-nav">
                      <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle hdrmenu" href="" id="navbarDarkDropdownMenuLink"
                ...
                <li class="nav-item  myli">
                  <a class="nav-link hdrmenu" href="#">Login</a>
                </li>
                <li class="nav-item  myli">
                  <a class="nav-link hdrmenu active" href="#">Register</a>
                </li>
                <li class="nav-item  myli">
                  <a class="nav-link hdrmenu" href="about.html">About</a>
                </li>
                <li class="nav-item myli">
                  <a class="nav-link hdrmenu" href="#">Contact</a>
                </li>
                <li class="nav-item myli">
  ...
  <div class="container">
    <div class="row  mt-5">
      <div class="col-md-7">
        <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" src="img/abt.jpg"
          style="justify-content: center; display: flex; height: 500px;">
      </div>
      <!-- for the form -->
      <div class="col-md-5">
        <form class="row " method="post" name="myForm" >
          <div class="form-floating mb-2 form-control-sm col-10">
            <input type="text" class="form-control " id="floatingTraderName" placeholder="CL Group" name="Name">
            <label for="floatingTraderName">Trader Name</label>
          </div>
          <div class="form-floating mb-2 form-control-sm col-10">
          ...
          <div class="form-floating mb-2 form-control-sm col-10">
            <input type="text" class="form-control" id="floatingEstDate" placeholder="2011">
            <label for="floatingEstDate">Est. Date</label>
          
          </div>
          <div class="form-floating mb-2 form-control-sm col-10">
            <input type="text" class="form-control" id="floatingShopNo" placeholder="2011">
            <label for="floatingShopNo">Shop No.</label>
          </div>
          <div class="form-floating mb-2 form-control-sm col-10">
            <input type="text" class="form-control" id="floatingPhone" placeholder="1204157413">
            <label for="floatingPhone">Phone No.</label>
          </div>
          <div class="mb-3 form-check " style="margin-left: 1rem;">
            <input type="checkbox" class="form-check-input" id="exampleCheck1">
            <label class="form-check-label" for="exampleCheck1"> I Agree to the terms and conditions of ShopUp</label>
          </div>
          <div class="form-control-sm">
            <button type="submit" class="btn btn-primary" style="padding: .5rem 2rem;" id="createBtn" >Create
              Account</button>
          </div>
          <p class="form-control-sm">Already have an account?<a href="#login.html"> Sign In</a> </p>
      ...
      <div class="row row-cols-5" style="padding: 0 2rem;">
        <div class="col">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
              <img src="img/about.png" alt="" style="height: 16px;">
